...
!function( $ ) {
 ...
 "use strict"
  ...
  , setup: function (element) {
      ...
      select.detach()
      combobox.addClass(select.data('combo-class'));
...
//      }
  ...
  template: '<div class="combobox-container input-append"><div class="input-wrapper"><input type="text" autocomplete="off"/></div><span class="add-on btn dropdown-toggle" data-dropdown="dropdown"><span class="caret"/><span class="combobox-clear"><i class="icon-remove"/></span></span></div>'
